    ...
    (b "func" 42
       (b "cast" 35
          (b "^" 32
             ...
             (b "bool" 34 (b "alignof" 33 N N) N))
          (b "end" 39
             (b "elif" 37 (b "char" 36 N N) (b "else" 38 N N))
             (b "false" 41 (b "f64" 40 N N) N)))
       (b "true" 49
          (b "return" 46
             (b "if" 44 (b "i64" 43 N N) (b "nil" 45 N N))
             (b "struct" 48 (b "sizeof" 47 N N) N))
          (b "|" 53
             (b "void" 51 (b "union" 50 N N) (b "while" 52 N N))
             (b "~" 55 (b "||" 54 N N) N))))
  where
  b s n = B bs (TS bs n)
    where
